...
export const DllOperationalPanel: React.FC = () => {
  ...
  useEffect(() => {
    const init: ExecutionStep = {
      step: 1, lineNum: 1,
      explanationEnglish: `Doubly Linked List initialized (Empty). Capacity: ${capacity}.`,
      explanationHinglish: `Doubly Linked List khali initialize hui hai. Capacity: ${capacity}.`,
      memorySnapshot: { capacity, list: [] },
      consoleOutput: `> Doubly Linked List initialized (Capacity: ${capacity}).`,
  ...
  const handleSearch = () => {
    ...
    for (let i = 0; i < list.length; i++) {
      ...
      steps.push({
        ...
        explanationEnglish: `Search: matching node [${i}] = ${list[i]}`,
