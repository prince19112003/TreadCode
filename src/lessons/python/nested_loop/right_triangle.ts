...
export const right_triangle: LessonProgram = {
  id: 'right_triangle', language: 'python', topic: 'nested_loop', lessonNumber: 2,
  friendlyName: 'Right Triangle Pattern',
  learningObjective: 'Learn how to make the inner loop depend on the outer loop variable.',
  lines: [
