...
export const number_triangle: LessonProgram = {
  id: 'number_triangle', language: 'python', topic: 'nested_loop', lessonNumber: 4,
  friendlyName: 'Number Triangle Pattern',
  learningObjective: 'Learn how to use inner loop variables to dynamically generate output values.',
  lines: [
    ...
    { lineNum: 4, tokens: [{ type: 'text', value: '        ' }, { type: 'function', value: 'print' }, { type: 'punctuation', value: '(' }, { type: 'variable', value: 'j' }, { type: 'punctuation', value: ',' }, { type: 'text', value: ' ' }, { type: 'variable', value: 'end' }, { type: 'operator', value: '=' }, { type: 'string', value: '" "' }, { type: 'punctuation', value: ')' }] },
    ...
    for (let i = 1; i <= limit; i++) {
      ...
      for (let j = 1; j <= i; j++) {
        ...
        steps.push({
          ...
          animationEvent: { type: 'PRINT_VALUE', variableName: 'print', outputValue: j },
        });
      }
